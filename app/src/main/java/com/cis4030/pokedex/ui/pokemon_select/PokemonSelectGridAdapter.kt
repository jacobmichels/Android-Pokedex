...
class PokemonSelectGridAdapter(private val onClickListener: OnClickListener) : ListAdapter<DatabasePokemon, PokemonSelectGridAdapter.PokemonViewHolder>(DiffCallback) {
